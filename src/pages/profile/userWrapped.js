...
const UserWrapped = () => {
  ...
  return (
    <Fragment>
      <Button onClick={onOpen}>Wrapped</Button>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Flex direction="column">
              {/* first section */}
              <SlideFade direction="left" in={isOpen} delay={0.5}>
                <Flex
                  marginTop="80px"
                  width="30%"
                  bgColor="teal"
              ...
              {/* second section */}
              <SlideFade direction="left" in={isOpen} delay={0.8}>
              ...
              {/* third section */}
              <SlideFade direction="left" in={isOpen} delay={1.2}>
                <Flex marginTop="20px" width="100%" direction="column">
                  <Text fontSize="4xl" fontWeight="bold">
